                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @Z_X_Z_B\
                                  \n\n--------بـدء تتبـع سجـل تليثــون القائد 𝗦𝗼𝗨𝗿𝗖𝗲 ™𝗟𝗲𝗔𝗱𝗘𝗿--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع تليثــون القائد 𝗦𝗼𝗨𝗿𝗖𝗲 ™𝗟𝗲𝗔𝗱𝗘𝗿--------"
                        ...
                        link = "[•𝐾 𝐺•™ 𝙇𝙚𝘼𝙙𝙀𝙧 ™⤶(https://t.me/Z_X_Z_B)"
                        text = (
                            "**✘ تقـريـر إشعـار تليثــون القائد 𝗦𝗼𝗨𝗿𝗖𝗲 ™𝗟𝗲𝗔𝗱𝗘𝗿 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار تليثــون القائد 𝗦𝗼𝗨𝗿𝗖𝗲 ™𝗟𝗲𝗔𝗱𝗘𝗿 ✘**\n\n "
                        link = "[•𝐾 𝐺•™ 𝙇𝙚𝘼𝙙𝙀𝙧 ™⤶(https://t.me/Z_X_Z_B)"
