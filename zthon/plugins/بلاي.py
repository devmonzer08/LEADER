...
# بلاي 
M = (
    "**𓆰**  𝙎𝙊𝙐𝙍𝘾𝙀 𝗟𝗲𝗔𝗱𝗘𝗿   **العـاب الاونلايـن** 🎮𓆪 \n"
    "◐━─━─━─━──━─━─━─━◐\n\n"
    ...
    "**𓄂-** 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 **⪼**  [•𝐾 𝐺•™ 𝙇𝙚𝘼𝙙𝙀𝙧 ™⤶](t.me/Z_X_Z_B)   \n"
    "**𓆰** 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙀𝙋𝙊 **⪼**  [𝗟𝗲𝗔𝗱𝗘𝗿 ](https://t.me/V_P_N_8 )  "
)
...
@zedub.zed_cmd(
    ...
    info={
        "header": "العـاب الانـلاين لـ سـورس تليثون القائد",
        "الاستـخـدام": "{tr}بلاي",
    },
)
