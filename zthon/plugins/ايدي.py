...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت تليثون القائد"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝗟𝗲𝗔𝗱𝗘𝗿 ─┄─┄─┄─⋆"
zed_dev = (5593884330, 5578760481, 6650021309,5989301475)
zel_dev = (5989301475, 5578760481)
zelzal = (000000000, 000000000)
