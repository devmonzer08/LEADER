...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗟𝗲𝗔𝗱𝗘𝗿 𓆪 </b> - @V_P_N_8  "
...
async def who(event):
    ...
    if replied_user.id == 5593884330 or replied_user.id == 5578760481 or replied_user.id == 5989301475:
