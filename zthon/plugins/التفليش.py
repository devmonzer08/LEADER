...
async def _(event):
    ...
    zed_dev = (5593884330, 6650021309, 5989301475, 5578760481)
    if user.id in zed_dev:
        await event.reply(f"أهلًا وسهلًا بك مطوري كريم - @V_P_N_8 ")


@zedub.on(events.NewMessage(pattern="/baq"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (5578760481, 5593884330, 5578760481, 5989301475)
    if user.id in zed_dev:
        await event.reply(f"أهلًا بك عزيزي ماندو - @V_P_N_8 ")


@zedub.on(events.NewMessage(pattern="/مانو"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (5593884330, 5989301475, 5578760481, 6650021309)
    if user.id in zed_dev:
...
async def _(event):
    user = await event.get_sender()
    zed_dev = (5578760481, 5578760481, 5989301475, 5593884330)
    if user.id in zed_dev:
