...
zel_dev = (5593884330, 5989301475, 5578760481, 6650021309)
...
async def zedgban(event):  # sourcery no-metrics
    ...
    if user.id == 5593884330 or user.id == 5578760481 or user.id == 6650021309 or user.id == 5989301475
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 5593884330 or user.id == 5578760481 or user.id == 5989301475: or user.id == 6650021309
