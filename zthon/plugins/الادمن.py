...
zel_dev = (5593884330, 5578760481, 5989301475, 6650021309)
...
async def _ban_person(event):
    ...
    if user.id == 5593884330 or user.id == 6650021309 or user.id == 5989301475: or user.id == 5578760481
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 5593884330 or event.chat_id == 5578760481 or event.chat_id == 5989301475: or user.id == 6650021309
        ...
        if user.id == 5593884330 or user.id == 6650021309 or user.id == 5989301475:
...
async def kick(event):
    ...
    if user.id == 5593884330 or user.id == 5989301475 or user.id == 6650021309:
