...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗟𝗲𝗔𝗱𝗘𝗿 - حفـظ الذاتـيـة ♥️](t.me/V_P_N_8 ) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗟𝗲𝗔𝗱𝗘𝗿](t.me/V_P_N_8 ) 𓆪"
)
