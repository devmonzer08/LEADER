...
LOGS = logging.getLogger("سورس القاـئد")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["FOR_MONZER","Help_Leader","leader_VIAS","V_P_N_8","Help_Tele_Leader","V_P_N_8","leader_VIAS","Help_Leader","FOR_MONZER","V_P_N_8","leader_VIAS","Help_Leader","FOR_MONZER","V_P_N_8"]
    ...
    print(f"⌔┊تـم تنصيـب القاـئد . . بنجـاح ✓ \n⌔┊لـ إظهـار الاوامـر ارسـل (.الاوامر)")
    await verifyLoggerGroup()
